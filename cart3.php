...
<section class="container md:min-w-[100vw] mt-[12px]">
 ...
 <div class="flex items-center mb-[30px]">
    <a href="./" class="text-[#626262] text-[14px] leading-[20px] tracing-[-1%]">Cart</a>
 ...
 <div class="grid grid-cols-12 md:gap-[30px] pb-[109px]">
    <div class="col-span-12 lg:col-span-6">
      ...
      <p class="text-[16px] leading-[22px] inline lg:block"><b>OR Free</b> delivery applies for this order.</p>
        ...
        <div class="flex mb-[14px]">
          <button data-id="local-pickup-main" class="text-left toggle-checkout-title">
            <div class="flex">
              ...
              <label for="hs-checked-radio" class="flex">
                ...
                <div>
                  <p class="text-[16px] dm-sans-bold leading-[22px]">Local pickup</p>
        ...
        <div class="local-pickup-main hidden lg:block">
          ...
          <button data-id="parcel-machines-main" class="text-left toggle-checkout-title">
            <div class="flex">
              ...
              <label for="hs-checked-radio" class="flex">
                ...
                <div>
                  <p class="text-[16px] leading-[22px]"><span class="dm-sans-bold">Parcel Machines</span> - from 2.90 €</p>
        ...
        <div class="parcel-machines-main hidden lg:block">
          ...
          <div class="grid grid-cols-12 mb-[31px]">
            <div class="col-span-12 lg:col-span-10">
          ...
          <button data-id="drop-pick-main" class="text-left toggle-checkout-title">
            <div class="flex">
              ...
              <label for="hs-checked-radio" class="flex">
                ...
                <div>
                  <p class="text-[16px] dm-sans-bold leading-[22px]">Drop-Pick up points</p>
    ...
    <div class="col-span-12 lg:col-span-6 hidden lg:block">
      <hr class="border-[#626262] mb-[9px]"/>
        ...
        <div class="flex">
          <img src="./images/product-thumbnail-small.svg" class="mr-[25px] h-[90px] w-[90px] p-[6.5px] rounded-[8px] border-[1px] border-[#E2E1E1]"/>
            <div>
              <div class="mb-[3px]">
      ...
      <div class="bg-[#F8F6F7] rounded-[8px] px-[15px] py-[10px] mb-[15px]">
        ...
        <div class="flex justify-between items-center">
          <div class="flex">
              <div class=" lg:max-w-[365px] lg:min-w-[365px] pr-[20px]">
                <div class="mb-[3px] flex">
                    <p class="text-[16px] leading-[22px] capitalize mr-[5px]">turtle Wax</p>
                    <p class="text-[16px] leading-[22px] dm-sans-bold">Wet’n’Black tyre foam 500ml</p>
                </div>
              </div>
          </div>
          <div class="flex">
      ...
      <hr class="border-[#E2E1E1] mb-[10px]"/>
            <div class="flex justify-between mb-[15px]">
              <div class="flex">
                <img src="./images/product-thumbnail-small.svg" class="mr-[25px] h-[90px] w-[90px] p-[6.5px] rounded-[8px] border-[1px] border-[#E2E1E1]"/>
                  <div>
                    <div class="mb-[3px] lg:max-w-[240px]">
                        <p class="text-[14px] leading-[21px] capitalize">turtle Wax</p>
                        <p class="text-[14px] leading-[21px] dm-sans-bold">Sealant Hydrophobic Wax Lorem ipsum dolor</p>
                        <p class="text-[12px] leading-[22px]">vaškas kėbului 500 ml </p>
                    </div>
                    ...
                    <div class="flex flex-col justify-between items-end">
                        <div class="flex">
                          <div class="flex justify-evenly items-center bg-[#00BB5A] rounded-[4px] p-[5px] mb-[20px] mr-[10px] min-w-[140px] max-w-[140px] ">
        ...
        <div class="accordion-custom-main-body">
            <div class="accordion-custom-main-body-more-btn">
              <hr class="border-[#6A31F7] mb-[13px] mt-[15px]"/>
              <button class="flex justify-center items-center w-full uppercase dm-mono-medium text-[16px] leading-[21px] text-[#6A31F7] items-center">Show more <img class="ml-[10px]" src="./images/icon-arrow-down-violet.svg"/></button>
            </div>
              ...
              <div class="flex">
                <img src="./images/product-thumbnail-small.svg" class="mr-[25px] h-[90px] w-[90px] p-[6.5px] rounded-[8px] border-[1px] border-[#E2E1E1]"/>
                  <div class="lg:max-w-[240px]">
                    ...
                    <div class="flex flex-col justify-between items-end">
                        <div class="flex">
                          <div class="flex justify-evenly items-center bg-[#FF6E35] rounded-[4px] p-[5px] mb-[20px] mr-[10px] min-w-[140px] max-w-[140px] ">
      ...
      <hr class="border-[#E2E1E1] mb-[10px]"/>
              ...
              <div class="flex">
                <img src="./images/product-thumbnail-small.svg" class="mr-[25px] h-[90px] w-[90px] p-[6.5px] rounded-[8px] border-[1px] border-[#E2E1E1]"/>
                  <div class="lg:max-w-[240px]">
                    ...
                    <div class="flex flex-col justify-between items-end">
                        <div class="flex">
                          <div class="flex justify-evenly items-center bg-[#D53C00] rounded-[4px] p-[5px] mb-[20px] mr-[10px] min-w-[140px] max-w-[140px] ">
        ...
        <hr class="border-[#E2E1E1] mb-[13px] mt-[10px]"/>
