...
<section class="container md:min-w-[100vw] mt-[12px]">
 ...
 <div class="flex items-center mb-[10px] lg:mb-[37px]">
        ...
        <div class="flex-grow">
          ...
          <div class="flex items-center justify-between mb-[22px] lg:mb-[36px] flex-wrap">
              <div class="flex items-center justify-between flex-wrap flex-grow mb-[10px] lg:mb-0 gap-x-[11px]">
                ...
                <div class="input-items-main h-[36px] max-w-[30vw] min-w-[110px] flex-grow border-[1px] border-[#E2E1E1] rounded-[20px] px-[9px] flex items-center lg:mr-[13px]">
            ...
            <div class="w-full lg:w-fit">
              <button class="uppercase w-full text-white bg-black lg:max-w-[316px] rounded-[20px] min-h-[35px] dm-mono-medium text-[16px] leading-[21px] tracing-[3%] flex items-center justify-center mt-[8px] p-[10px]">to cart / inform when in stock <img class="ml-[10px]" src="./images/icon-next-btn.svg"></button>
            </div>
          </div>
