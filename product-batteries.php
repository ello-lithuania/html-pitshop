  ...
  <div class="grid grid-cols-12 lg:gap-[30px] mb-[20px] lg:mb-[40px]">
    <div class="col-span-12 lg:col-span-12">
      <div class="flex flex-wrap xl:flex-nowrap">
        ...
        <div class="lg:mr-[30px] order-first lg:order-none w-full lg:w-fit mb-[9px] lg:mb-0">
        ...
        <div class="flex-grow">
          ...
          <div class="flex items-center justify-between mb-[15px] lg:mb-[27px] flex-wrap">
            ...
            <div class="w-full sm:max-w-[317px] sm:min-w-[317px] bg-[#FF6E35] rounded-[4px] p-[8px] flex items-center justify-between">
              <div class="flex items-center">
                <img src="./images/icon-dot-white.svg" class="mr-[10px]"/>
                <div>
                  <p class="dm-sans-bold text-[12px] lg:text-[16px] leading-[15px] lg:leading-[22px] tracing-[-1%] text-white"><b>9.73 € with code</b> <span class="underline abel">30OFF</span></p>
                  <div class="flex items-center">
                    <p class="abel underline text-[12px] leading-[15px] text-white mr-[20px] cursor-pointer">Click to activate code</p>
                    <img src="./images/icon-info-box-white.svg"/>
                  </div>
                </div>
              </div>
              <div class="flex items-center">
                ...
                <div class="flex flex-col lg:flex-row text-center">
                  <p class="text-[12px] lg:text-[26px] text-white">-30%</p>
                  <p class="lg:hidden dm-sans-bold text-[12px] text-white ">From base price</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-12 gap-x-[10px] lg:gap-[31px]">
            <div class="col-span-6 lg:col-span-6">
                  <a href="" class="rounded-[8px] mb-[10px] border-[2px] border-[#6A31F7] p-[11px] lg:py-[10px] lg:px-[19px] flex items-start justify-between">
                    <div class="flex">
                      <img src="./images/icon-good-toknow.svg" class="mr-[10px] lg:mr-[20px]"/>
                      <p class="dm-sans-bold text-[14px] lg:text-[16px] lg:leading-[20px] text-[#6A31F7]">Good to know</p>
                    </div>
                    <img src="./images/icon-btn-right2.svg"/>
                  </a>
            </div>
            <div class="col-span-6 lg:col-span-6">
                  <a href="" class="rounded-[8px] border-[2px] border-[#6A31F7] p-[11px] lg:py-[10px] lg:px-[19px] flex items-start justify-between">
                    <div class="flex">
                      <img src="./images/icon-battery.svg" class="mr-[10px] lg:mr-[20px]"/>
                      <p class="dm-sans-bold text-[14px] lg:text-[16px] lg:leading-[20px] text-[#6A31F7]">Battery Service</p>
                    </div>
                    <img src="./images/icon-btn-right2.svg"/>
                  </a>
            </div>
