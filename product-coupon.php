      ...
      <div class="flex flex-wrap xl:flex-nowrap">
        ...
        <div class="flex-grow">
          ...
          <div class="flex flex-row justify-between lg:justify-start lg:flex-col flex-wrap">
            <p class="flex-2 text-[14px] lg:text-[20px] tracing-[-1%] mb-[9px] lg:mb-[20px] mr-[11px] lg:mr-0">ratlankių ir padangų valiklis 500 ml</p>
          ...
          <div class="flex items-center justify-between mb-[15px] lg:mb-[27px] flex-wrap">
            ...
            <div class="sm:min-w-[317px] bg-[#00BB5A] rounded-[4px] p-[8px] flex items-center justify-between">
              <div class="flex items-center">
                <img src="./images/icon-dot-white.svg" class="mr-[10px]"/>
                <div>
                  <p class="dm-sans-bold text-[16px] leading-[22px] tracing-[-1%] text-white"><b>9.73 € with code</b> <span class="underline abel">30OFF</span></p>
                  <div class="flex items-center">
                    <p class="abel underline text-[12px] leading-[15px] text-white mr-[20px] cursor-pointer">Activated</p>
                    <img src="./images/icon-coupon.svg"/>
                  </div>
                </div>
              </div>
              <div class="flex items-center">
          ...
          <hr class="border-[#E2E1E1] mt-[10px] mb-[13px]"/>

          <div class="flex justify-between flex-wrap lg:flex-nowrap">
            <p class="text-[#626262] text-[12px] leading-[20px] mb-[10px] lg:mb-0">Amount</p>
            <div class="sm:min-w-[317px] flex justify-between items-center coupon-select-main">
              <button class="coupon-select-main-active dm-sans-bold text-[16px] leading-[22px] rounded-[20px] w-[91px] h-[37px] flex items-center justify-center">500 ml</button>
              <button class="dm-sans-bold text-[16px] leading-[22px] rounded-[20px] w-[91px] h-[37px] flex items-center justify-center">75 ml</button>
              <button class="dm-sans-bold text-[16px] leading-[22px] rounded-[20px] w-[91px] h-[37px] flex items-center justify-center">980 ml</button>
            </div>
          </div>

          <hr class="border-[#E2E1E1] mt-[11px] mb-[5px]"/>
          ...
          <hr class="border-[#E2E1E1] mb-[23px]"/>

          <div class="flex items-center justify-between mb-[36px] flex-wrap">
              <div class="flex items-center justify-between flex-wrap flex-grow mb-[10px] lg:mb-0 gap-x-[11px]">
                ...
                <div class="input-items-main h-[36px] flex-grow min-w-[101px] border-[1px] border-[#E2E1E1] rounded-[20px] px-[15px] flex items-center mr-[13px]">
                  <button class="input-items-main-decrease border-[1px] border-black w-[14px] h-[14px] px-[2.92px] rounded-full"><img class="w-full" src="./images/icon-input-decrease.svg"/></button>
                  ...
                  <button class="input-items-main-increase border-[1px] border-black w-[14px] h-[14px] px-[2.92px] rounded-full"><img class="w-full" src="./images/icon-input-increase.svg"/></button>
                </div>
              </div>
            <div class="w-full lg:w-fit">
              <button class="uppercase text-white bg-black lg:max-w-[316px] rounded-[20px] min-h-[35px] dm-mono-medium text-[16px] leading-[21px] tracing-[3%] flex items-center justify-center mt-[8px] p-[10px] min-w-[316px]">to cart <img class="ml-[10px]" src="./images/icon-next-btn.svg"></button>
            </div>
          </div>
