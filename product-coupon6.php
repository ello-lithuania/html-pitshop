    ...
    <div class="col-span-12 lg:col-span-12">
      <div class="flex flex-wrap xl:flex-nowrap">
        ...
        <div class="flex-grow">
          ...
          <div class="flex items-center justify-between mb-[15px] lg:mb-[27px] flex-wrap lg:flex-nowrap">
            <div class="min-w-fit">
              <div class="flex items-center mb-[15px]">
                <img src="./images/icon-offer.svg" class="mr-[6px]"/>
                <p class="text-[#626262] text-[12px] leading-[15px]">Your Special price -15%</p>
              </div>
              <p class="dm-sans-medium text-[28px] lg:text-[40px] lg:leading-[46px] tracing-[-1%] mb-0 lg:mb-[15px] min-w-fit">12 000.27 €</p>
              <p class="min-w-fit text-[#626262] text-[12px] leading-[15px] tracing-[-1%] mt-[15px]">Base price 8.5935 € + VAT</p>
            </div>
            ...
            <div class="w-full sm:min-w-[315px] lg:max-w-[315px] bg-[#D53C00] rounded-[4px] p-[8px] flex items-center justify-between mb-[9px]">
              <div class="flex items-center">
                <img src="./images/icon-dot-white.svg" class="mr-[10px]">
                <div>
                  <p class="text-[26px] text-white uppercase">sellout</p>
                </div>
              </div>
              <div class="flex items-center">
                <img src="./images/icon-border-dotted.svg" class="mr-[10px]">
                <div class="text-center">
                  <p class="text-white text-[16px] leading-[22px] dm-sans-bold">-30%</p>
                  <p class="text-white text-[12px] leading-[12px] abel">From base price</p>
                </div>
              </div>
            </div>
          ...
          <hr class="border-[#E2E1E1] mt-[15px] mb-[10px]"/>

          <div class="flex justify-between flex-wrap lg:flex-nowrap">
            <p class="text-[#626262] text-[12px] leading-[15px] mb-[10px] lg:max-w-[143px]">Nuolaida perkant didesnį kiekį</p>
            <div class="sm:min-w-[317px] flex justify-between items-center coupon-select-main">
              <button class="coupon-select-main-active dm-sans-bold text-[16px] leading-[22px] rounded-[20px] px-[20px] py-[10px] min-w-[91px] min-h-[37px] flex flex-col items-center justify-center"><span class="dm-sans-regular text-[16px] leading-[22px]">54 vnt.</span>10.80 €</button>
              <button class="dm-sans-bold text-[16px] leading-[22px] rounded-[20px] px-[20px] py-[10px] min-w-[91px] min-h-[37px] flex flex-col items-center justify-center"><span class="dm-sans-regular text-[16px] leading-[22px]">32 vnt.</span>5.90 €</button>
              <button class="dm-sans-bold text-[16px] leading-[22px] rounded-[20px] px-[20px] py-[10px] min-w-[91px] min-h-[37px] flex flex-col items-center justify-center"><span class="dm-sans-regular text-[16px] leading-[22px]">16 vnt.</span>3.30 €</button>
            </div>
          </div>

          <hr class="border-[#E2E1E1] mt-[14px] mb-[8px]"/>
